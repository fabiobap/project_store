...
try{
    ...
    $products = $productDao->getNameAndCategory($page, $per_page, $name, $categoryId);
    $productsToPagination = $productDao->getNameAndCategoryToPagination($name, $categoryId);
...
<ul class="pagination justify-content-center pagination-lg">
    <?php
        $href = "product-search.php?name=".$name."&category=".$categoryId; 
